public class L6 {
    public static void main(String[] args) {
        ...
        // never use 3.4 its inaccurate instead use
        System.out.println(Math.PI);

        //math.max(double a, double b ) = returns highest of two values as their data types
        //math.min(double a, double b ) = return the lowest of two values as their data types
